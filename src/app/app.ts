...
export class App {
  ...
  translations: Record<Language, Translations> = {
    es: {
      ...
      testimonials: { tag: 'Testimonios', title1: 'Lo que Dicen', title2: 'Nuestros Clientes', testimonial1: { text: '"¡Recomiendo mucho a Olga! La conozco a ella y a su familia desde antes de la pandemia y siempre es un placer trabajar con ella. Muy trabajadora, confiable, eficiente, flexible y con excelentes sugerencias. Limpia con productos completamente naturales. ¡Definitivamente contraten a Olga!"', name: 'Tiffany P.', location: 'Boston, MA' }, testimonial2: { text: '"Olga llegó a nuestra familia no como una empresa con fines de lucro. Se presentó como alguien que quería ser parte de nuestra familia. No solo limpia; organiza y da ideas sobre cómo simplificar y mantener la casa libre de estrés. ¡La recomendamos ampliamente!"', name: 'Familia Daniel', location: 'Boston, MA' }, testimonial3: { text: '"Recuerdo un día, después de una larga jornada de trabajo, llegué a casa con gripe. En cuanto entré, sentí que mis fosas nasales se despejaron con el aroma a eucalipto de los productos de Olga. Entendí que los químicos no son buenos para nuestra salud."', name: 'Ricky J.', location: 'Boston, MA' }, testimonial4: { text: '"Olga ha sido una ayuda increíble para mí a lo largo de los años. Tiene habilidades que yo no poseo y todos estamos agradecidos por todo lo que hace por nosotros."', name: 'Tricia M.', location: 'Boston, MA' }, testimonial5: { text: '"¡Trabajar con Olga ha sido un placer! Trajo de vuelta la limpieza y el orden a nuestro hogar después de que tuve una operación muy seria. Es trabajadora, confiable y una excelente organizadora. ¡La recomendamos absolutamente!"', name: 'Lisa', location: 'Boston, MA' } },
    ...
    en: {
      ...
      testimonials: { tag: 'Testimonials', title1: 'What Our', title2: 'Clients Say', testimonial1: { text: '"Highly recommend Olga! I\'ve known her and her family since before the pandemic and she is always great to work with. Very hard working, trustworthy, efficient, flexible and has great suggestions. She cleans using all natural products. Definitely hire Olga!"', name: 'Tiffany P.', location: 'Boston, MA' }, testimonial2: { text: '"Olga came to our family not as a profit-making company. She presented herself as someone who wants to be a member of our family. She doesn\'t just clean; she organizes and gives ideas on how to simplify and keep our house stress free. We highly recommend her!"', name: 'Daniel\'s Family', location: 'Boston, MA' }, testimonial3: { text: '"I remember one day after a long day at the office, I came home sick with the flu. As soon as I entered, I felt my nasal passages clear from the eucalyptus scent of Olga\'s products. I understood then that chemicals aren\'t good for our health. I highly recommend her!"', name: 'Ricky J.', location: 'Boston, MA' }, testimonial4: { text: '"Olga has been an amazing help to me over the years. She has skills that I do not possess and we are all grateful for all she does for us."', name: 'Tricia M.', location: 'Boston, MA' }, testimonial5: { text: '"Working with Olga has been a delight! She really brought cleanliness and order back to our home after I had a very serious operation. She is hard-working, reliable, and an excellent organizer. We would absolutely recommend her."', name: 'Lisa', location: 'Boston, MA' } },
